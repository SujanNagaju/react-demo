...
export default function TextForm(props) {
  ...
  const handleIdiClick = ()=> {
    // console.log( "Uppercase was clicked" );
    let newText = text.replace("chamatkar", "balatkar");toUpperCase();
    setText( newText );
  }
    ...
    <>
      <div className="container">
        <h2>{props.heading}</h2>
          ...
          <button className="btn btn-secondary mx-2" onClick={handleIdiClick}>Idiotic change</button>
      </div>
