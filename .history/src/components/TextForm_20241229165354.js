...
export default function TextForm(props) {
  ...
  return (
    <>
      <div className="container" style={{color: props.mode === 'light' ? 'black' }}>
        <h2>{props.heading}</h2>
          <div className="mb-3">
              <textarea className="form-control" id="textBox" onChange={handleOnChange} style={{backgroundColor: props.mode === 'light' ? 'white' : 'black'}} value={text} rows="8"></textarea>
          </div>
