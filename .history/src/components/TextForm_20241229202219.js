  ...
  return (
    <>
      <div className="container" style={{color: props.mode === 'light' ? 'black' : 'white' }}>
        <h2>{props.heading}</h2>
          <div className="mb-3">
              <textarea className="form-control" id="textBox" onChange={handleOnChange} style={
                {
                  backgroundColor: props.mode === 'light' ? 'white' : '#201e2e', 
      ...
      <div className="container" style={{color: props.mode === 'light' ? 'black' : 'white' }}>
        ...
        <h3>Preview</h3>
        <p id="blinkPreview" style={{color: props.mode === 'light' ? 'black' : 'white'}}>{text != '' ? text : 'Enter text to generate preview'}</p>
      </div>
    </>
  )
}
